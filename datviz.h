...
extern "C"
{
   ...
   * */
  void datviz_destroy(datviz_z* viz);
   ...
   * */
  void datviz_add_logger(datviz_z* viz, void* logger_data, datviz_logger_callback callback);
   ...
   * */
  void datviz_set_window_title(datviz_z* viz, const char* title);
   ...
   * */
  void datviz_begin_frame(datviz_z* viz);
   ...
   * */
  void datviz_render_points(datviz_z* viz, const void* xyz_rgb, uint32_t point_count);
   ...
   * */
  void datviz_end_frame(datviz_z* viz);
   ...
   * */
  void datviz_get_window_size(datviz_z* viz, int* w, int* h);
   ...
   * */
  void datviz_get_framebuffer_size(datviz_z* viz, int* w, int* h);
   ...
   * */
  void datviz_set_background(datviz_z* viz, float r, float g, float b);
   ...
   * */
  void datviz_set_view_transform(datviz_z* viz, const float* view_transform);
   ...
   * */
  void datviz_look_at(datviz_z* viz, const float* eye, const float* center, const float* up);
   ...
   * */
  void datviz_set_projection_transform(datviz_z* viz, const float* projection_transform);
   ...
   * */
  void datviz_set_perspective(datviz_z* viz, float fovy, float near, float far);
   ...
   * */
  void datviz_set_model_transform(datviz_z* viz, const float* model_transform);
   ...
   * */
  void datviz_poll_input(datviz_z* viz);
   ...
   * */
  int datviz_should_close(datviz_z* viz);
